          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-center w-full">
              <label
                ...
                className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer dark:(bg-dark-card border-2 border-dark-border)"
              >
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-global-green text-white rounded-lg w-32 dark:(bg-global-yellow text-black)"
            >
              Register
            </button>
          </div>
